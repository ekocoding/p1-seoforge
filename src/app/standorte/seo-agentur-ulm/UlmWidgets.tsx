...
const keywords = [
  { kw: "Webdesign Ulm",        vol: 390, pct: 100 },
  { kw: "SEO Ulm",              vol: 290, pct: 74  },
  { kw: "Online Marketing Ulm", vol: 210, pct: 54  },
  { kw: "SEO Agentur Ulm",      vol: 160, pct: 41  },
  { kw: "Marketing Ulm",        vol: 120, pct: 31  },
];

const rankingData = [
  { month: "Monat 1", pos: 44, traffic: 9   },
  { month: "Monat 2", pos: 33, traffic: 24  },
  { month: "Monat 3", pos: 20, traffic: 63  },
  { month: "Monat 4", pos: 11, traffic: 141 },
  { month: "Monat 5", pos: 5,  traffic: 295 },
  { month: "Monat 6", pos: 2,  traffic: 482 },
];
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 items-center">
          <div>
            ...
            <h2 className="font-[family-name:var(--font-heading)] text-3xl font-bold text-dark sm:text-4xl mb-4">
              So suchen Ulmer <span className="gradient-text">nach Ihren Leistungen</span>
            </h2>
            <p className="text-base text-muted leading-relaxed mb-6">
              Monatliche Suchanfragen bei Google zeigen, welche Begriffe in Ulm
              wirklich gefragt sind. Wer diese Keywords nicht bespielt, verschenkt
              qualifizierten Traffic an Wettbewerber — besonders in MedTech und Automotive.
            </p>
  ...
  return (
    <div ref={ref as React.RefObject<HTMLDivElement>}>
      ...
      <p className="text-base text-muted leading-relaxed mb-8">
        Ein typisches SeoForge-Projekt für ein Ulmer MedTech-Unternehmen.
        Organischer Traffic wächst mit jeder besseren Position überproportional —
        besonders im B2B-Industrie- und Wissenschaftsmarkt.
      </p>
      <div className="bg-offwhite rounded-2xl border border-border p-5">
        ...
        <div className="mt-4 pt-3 border-t border-border flex items-center justify-between text-xs text-muted">
          <span>Organischer Traffic: <span className="font-semibold text-primary">+5.256%</span></span>
