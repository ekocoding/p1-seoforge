...
const faqs = [
  { q: "Warum reicht eine einmalige SEO-Optimierung nicht aus?", a: "Google aendert seinen Algorithmus ueber 500 Mal pro Jahr. Ihre Konkurrenz optimiert staendig. Einmalige Massnahmen verpuffen — kontinuierliche Betreuung sichert und baut Ihre Positionen systematisch aus." },
  { q: "Wie lange dauert es bis ich Ergebnisse sehe?", a: "Erste Verbesserungen nach 1–3 Monaten. Technische Quick Wins wirken sofort. Nachhaltige Rankings entwickeln sich ueber 6–12 Monate. SEO ist ein Marathon — aber die Wirkung ist langfristig." },
  { q: "Wie laeuft die Zusammenarbeit ab?", a: "Monatlicher Zyklus: 1) Analyse & Audit, 2) Massnahmenplanung nach Impact, 3) Umsetzung durch unser Team, 4) Transparentes Reporting & persoenliches Review-Gespraech." },
  { q: "Was unterscheidet SeoForge von anderen Agenturen?", a: "Direkter Kontakt zum Chef — keine Account-Manager. Wir kombinieren klassische SEO mit GEO fuer KI-Sichtbarkeit. Datengetrieben, transparent, ohne Vertragsfalle." },
  { q: "Kann ich jederzeit kuendigen?", a: "Nach 3 Monaten Mindestlaufzeit monatlich kuendbar. Wir setzen auf Qualitaet und Ergebnisse — nicht auf lange Vertragsbindungen." },
  { q: "Was kostet die monatliche Betreuung?", a: "Die Investition richtet sich nach Projektumfang, Wettbewerb und Zielen. Im kostenlosen Erstgespraech erstellen wir ein transparentes, individuelles Angebot." },
];
          ...
          <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted hero-description">
                Einmalige Massnahmen verpuffen. Professionelle SEO-Betreuung sichert nicht nur Rankings — sie entwickelt Ihre Website systematisch zur Branchen-Autoritaet weiter.
              </p>
              ...
              <div className="mt-8 flex items-center gap-3 animate-fade-up" style={{ animationDelay: "0.6s" }}>
                ...
                <p className="text-xs text-muted">Ueber <span className="font-semibold text-dark">200+ Unternehmen</span> betreut</p>
              </div>
            </div>
            <BetreuungMockup />
          </div>
      ...
      <section className="bg-offwhite border-y border-border py-12 lg:py-16">
        <div className="mx-auto max-w-5xl px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            <Counter value={200} suffix="+" label="Unternehmen betreut" />
            <Counter value={127} suffix="%" label="Durchschn. Traffic-Wachstum" />
            <Counter value={12} suffix=" Mon." label="Durchschn. Laufzeit" />
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className={`transition-all duration-700 ${whyInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
            <div className="mx-auto max-w-3xl text-center mb-16">
              <span className="inline-block text-xs font-bold tracking-[0.2em] uppercase text-primary mb-4">Die Realitaet</span>
              ...
              <p className="text-lg text-muted">Google aendert seinen Algorithmus ueber <strong className="text-dark">500 Mal pro Jahr</strong>. Ihre Konkurrenz optimiert taeglich. Nur kontinuierliche Betreuung haelt Ihre Positionen — und baut sie aus.</p>
            </div>

            {/* 4 Reasons as creative cards */}
            <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
              {[
                { title: "Algorithmus-Resilienz", desc: "Proaktive Anpassung an Google Core Updates. Wir reagieren nicht erst wenn Rankings fallen — wir antizipieren.", icon: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z" /></svg>, color: "border-t-green-500" },
                ...
                { title: "ROI-Fokus", desc: "Nicht nur Traffic — Conversion-Rate und Lead-Qualitaet messbar steigern. Jede Massnahme hat ein Geschaeftsziel.", icon: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>, color: "border-t-secondary" },
                { title: "Datenbasierte Agilitaet", desc: "Laufendes Monitoring von Rankings, Wettbewerb und Suchintentionen. Schnelle Kurskorrekturen bei Veraenderungen.", icon: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3v11.25A2.25 2.25 0 006 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0l-1 3m8.5-3l1 3m0 0l.5 1.5m-.5-1.5h-9.5m0 0l-.5 1.5M9 11.25v1.5M12 9v3.75m3-6v6" /></svg>, color: "border-t-primary" },
              ].map((item, i) => (
      ...
      <section id="leistungen" ref={scopeRef as React.RefObject<HTMLElement>} className="bg-offwhite py-24 lg:py-32 border-y border-border">
        <div className="mx-auto max-w-6xl px-6 lg:px-8">
          <div className={`mb-14 transition-all duration-700 ${scopeInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
            ...
            <p className="text-lg text-muted max-w-2xl">Sechs Disziplinen, ein Ziel: Ihre Website jeden Monat staerker machen.</p>
          </div>
          ...
          <div className={`grid md:grid-cols-2 lg:grid-cols-3 gap-5 transition-all duration-700 delay-200 ${scopeInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
            ...
            <div className="md:col-span-2 rounded-2xl border-2 border-primary/15 bg-gradient-to-br from-primary/[0.03] to-secondary/[0.02] p-8 transition-all duration-300 hover:shadow-xl">
              <div className="flex items-start gap-5">
                ...
                <div>
                  ...
                  <p className="text-muted leading-relaxed">Rankings, KI-Zitationen, Wettbewerb — wir behalten alles im Blick. Marktveraenderungen und Content-Gaps erkennen wir frueh und reagieren proaktiv, bevor Sie Positionen verlieren.</p>
                </div>
              </div>
            </div>
            ...
            {/* Regular cards */}
            {[
              { num: "02", title: "On-Page & Semantik", desc: "Schema-Markups, Verlinkung, Pillar Pages. Thematische Autoritaet staerken." },
              ...
              { num: "05", title: "Linkbuilding", desc: "Hochwertige Backlinks. Qualitaet und Relevanz statt Masse." },
      ...
      <section ref={cycleRef as React.RefObject<HTMLElement>} className="bg-white py-24 lg:py-32">
        <div className="mx-auto max-w-5xl px-6 lg:px-8">
          <div className={`text-center mb-16 transition-all duration-700 ${cycleInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
            ...
            <p className="text-lg text-muted max-w-2xl mx-auto">Kein Anfang, kein Ende — ein Kreislauf der Ihre Website mit jeder Runde staerker macht.</p>
          </div>
        ...
        <div className="mx-auto max-w-6xl px-6 lg:px-8">
          <div className={`grid lg:grid-cols-12 gap-12 items-center transition-all duration-700 ${whoInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
            <div className="lg:col-span-4">
              <span className="inline-block text-xs font-bold tracking-[0.2em] uppercase text-primary mb-4">Fuer wen</span>
              <h2 className="font-[family-name:var(--font-heading)] text-3xl lg:text-4xl font-bold text-dark mb-4">Ist unsere Betreuung das Richtige fuer Sie?</h2>
              <p className="text-muted leading-relaxed mb-6">Unsere SEO Betreuung ist der richtige Schritt fuer alle, die SEO nicht als einmaliges Projekt, sondern als Wachstumsstrategie verstehen.</p>
            ...
            <div className="lg:col-span-8 space-y-4">
              {[
                { title: "Etablierte Unternehmen", desc: "Rankings absichern, systematisch ausbauen, Marktposition verteidigen. Fuer alle die organischen Traffic als Geschaeftsgrundlage verstehen.", tag: "Wachstum sichern" },
                { title: "E-Commerce & Online-Shops", desc: "Produkt-Rankings, Kategorie-Traffic und KI-Shopping-Empfehlungen kontinuierlich steigern. Mehr organischer Umsatz, Monat fuer Monat.", tag: "Umsatz steigern" },
                { title: "B2B, SaaS & Industrie", desc: "Topical Authority in Nischenmaerkten aufbauen. Qualifizierte Leads generieren durch Content der die richtigen Entscheider erreicht.", tag: "Leads generieren" },
              ].map((item, i) => (
                <Reveal key={item.title} delay={i * 100}>
              ...
              <div className="grid md:grid-cols-2 gap-0">
                <div className="p-8 lg:p-10">
                  ...
                  <ul className="space-y-4">
                    {[
                      { title: "Projektumfang", desc: "Website-Groesse, Keywords, Content-Bedarf" },
                      { title: "Wettbewerb", desc: "Branchenspezifische Konkurrenzsituation" },
                      { title: "Ihre Ziele", desc: "Traffic, Leads, Umsatz, Markenaufbau" },
                      { title: "Ausgangssituation", desc: "Technischer Zustand, bestehende Autoritaet" },
                    ].map((item, i) => (
                ...
                <div className="p-8 lg:p-10 bg-white border-l border-border">
                  <h3 className="font-[family-name:var(--font-heading)] text-xl font-bold text-dark mb-6">Was Sie erwarten koennen</h3>
                  <div className="space-y-4 mb-6">
                    {[
                      { label: "Traffic-Wachstum", value: "+40–120%" },
                      { label: "ROI-Timeline", value: "6–12 Monate" },
                      { label: "Vertragslaufzeit", value: "Flexibel" },
                      { label: "Kuendbarkeit", value: "Monatlich" },
                    ].map((m) => (
      ...
      <section className="bg-white py-24 lg:py-32" id="kontakt">
        <div className="mx-auto max-w-3xl px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="font-[family-name:var(--font-heading)] text-3xl lg:text-4xl font-bold text-dark mb-4">Erstgespraech vereinbaren</h2>
          ...
          <div className="rounded-3xl border border-border bg-offwhite/30 p-8 lg:p-10">
            <form className="space-y-5" action="/kontakt" method="POST">
              ...
              <button type="submit" className="w-full rounded-full bg-primary px-6 py-4 text-base font-semibold text-white transition-all hover:bg-primary-dark hover:shadow-lg hover:shadow-primary/20">Erstgespraech anfragen</button>
      ...
      <section className="relative py-24 lg:py-32 bg-dark text-white overflow-hidden">
        ...
        <div className="relative mx-auto max-w-3xl px-6 lg:px-8 text-center">
          <h2 className="font-[family-name:var(--font-heading)] text-3xl lg:text-5xl font-bold mb-6 leading-tight">
            Bereit fuer kontinuierliches{" "}<span className="text-primary">Wachstum</span>?
          </h2>
          <p className="text-lg text-white/60 mb-10 max-w-xl mx-auto">Lassen Sie uns besprechen, wie wir Ihre SEO auf das naechste Level bringen.</p>
