...
/* ------------------------------------------------------------------ */
const faqs = [
  { q: "Was kostet ein SEO Audit bei SeoForge?", a: "Ein umfassender SEO Audit startet ab 1.500 Euro fuer kleine Websites (bis 50 Seiten). Fuer groessere Projekte erstellen wir ein individuelles Angebot basierend auf Seitenanzahl, Komplexitaet und Wettbewerbsumfeld." },
  { q: "Wie lange dauert ein SEO Audit?", a: "Die Analyse dauert 1–2 Werktage, je nach Website-Groesse. Sie erhalten einen ausfuehrlichen Report plus ein 60-minuetiges Ergebnisgespraech. Express-Audits (3 Werktage) sind gegen Aufpreis moeglich." },
  { q: "Was ist der Unterschied zwischen Audit und Beratung?", a: "Ein Audit ist eine Bestandsaufnahme: Wo stehen Sie? Was funktioniert? Was nicht? Beratung geht weiter und entwickelt eine Strategie fuer die Zukunft. Oft starten Kunden mit dem Audit und wechseln dann zur laufenden Beratung." },
  { q: "Kann mein Team die Empfehlungen selbst umsetzen?", a: "Ja — der Aktionsplan ist so geschrieben, dass Ihr Entwickler- und Marketing-Team die Massnahmen eigenstaendig umsetzen kann. Jede Empfehlung enthaelt Prioritaet, Aufwand und erwarteten Impact. Bei Bedarf begleiten wir die Umsetzung." },
  { q: "Wie oft sollte man einen SEO Audit machen?", a: "Mindestens einmal jaehrlich oder bei groesseren Website-Aenderungen (Relaunch, Migration, neues CMS). Bei stark umkaempften Maerkten empfehlen wir halbjaehrliche Audits, um der Konkurrenz voraus zu bleiben." },
  { q: "Pruefen Sie auch die Konkurrenz?", a: "Ja, eine Wettbewerbsanalyse ist fester Bestandteil jedes Audits. Wir vergleichen Ihre Website mit den Top-3 Konkurrenten in Ihrer Branche und identifizieren ungenutztes Potenzial." },
];
          ...
          <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted hero-description">
                Bevor wir optimieren, muessen wir verstehen. Unser SEO Audit durchleuchtet Ihre Website auf ueber 200 Faktoren — technisch, inhaltlich, strukturell. Das Ergebnis: Ein klarer Aktionsplan, der zeigt, wo die groessten Hebel liegen.
              </p>
              <div className="mt-6 flex flex-wrap items-center gap-x-6 gap-y-2 animate-fade-up" style={{ animationDelay: "0.4s" }}>
                {["200+ Pruefpunkte", "Priorisierter Aktionsplan", "Inkl. Ergebnisgespraech"].map((p) => (
              ...
              <div className="mt-8 flex items-center gap-3 animate-fade-up" style={{ animationDelay: "0.6s" }}>
                ...
                <p className="text-xs text-muted">Ueber <span className="font-semibold text-dark">500 Audits</span> durchgefuehrt</p>
              </div>
            </div>
            <AuditMockup />
          </div>
      ...
      <section className="bg-offwhite border-y border-border py-12 lg:py-16">
        <div className="mx-auto max-w-5xl px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            <Counter value={200} suffix="+" label="Pruefpunkte pro Audit" />
            <Counter value={500} suffix="+" label="Audits durchgefuehrt" />
          ...
          <div className={`transition-all duration-700 ${editInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
            ...
            <div className="mx-auto max-w-3xl text-center mb-16">
              ...
              <p className="text-lg lg:text-xl text-muted leading-relaxed">
                Die meisten Unternehmen optimieren blind: Blog-Artikel ohne Keyword-Recherche, Speed-Optimierung waehrend Crawl-Fehler die wichtigsten Seiten unsichtbar machen, Backlink-Aufbau waehrend technische Probleme den Link-Juice vernichten. Ein Audit deckt auf, was wirklich los ist.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  desc: "Seiten die Google nicht crawlen kann, Duplicate Content der Rankings kannibalisiert, fehlende Meta-Daten auf Dutzenden Seiten — Probleme, die Sie ohne Audit nie finden wuerden.",
                  accent: "border-t-red-400",
                },
                {
                  title: "Falsches Budget",
                  desc: "Geld fuer Massnahmen ausgeben, die kaum Impact haben, waehrend Quick Wins mit minimalem Aufwand unentdeckt bleiben. Ohne Priorisierung verbrennen Sie Ressourcen.",
                ...
                },
                {
                  ...
                  desc: "Ihre Konkurrenz optimiert systematisch. Ohne Ueberblick ueber Ihre eigene Position und deren Staerken verlieren Sie Rankings — schleichend, aber messbar.",
      ...
      <section id="bereiche" ref={areasRef as React.RefObject<HTMLElement>} className="bg-offwhite py-24 lg:py-32 border-y border-border">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className={`text-center mb-16 transition-all duration-700 ${areasInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
            ...
            <h2 className="font-[family-name:var(--font-heading)] text-3xl lg:text-5xl font-bold text-dark mb-4">Was wir in Ihrem Audit pruefen</h2>
            ...
            <div>
              ...
              <div className="space-y-5">
                {[
                  ...
                  { title: "60 Min. Ergebnisgespraech", desc: "Persoenliche Praesentation aller Findings. Fragen beantworten, Prioritaeten besprechen, naechste Schritte planen.", icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193-.34.027-.68.052-1.02.072v3.091l-3-3c-1.354 0-2.694-.055-4.02-.163a2.115 2.115 0 01-.825-.242m9.345-8.334a2.126 2.126 0 00-.476-.095 48.64 48.64 0 00-8.048 0c-1.131.094-1.976 1.057-1.976 2.192v4.286c0 .837.46 1.58 1.155 1.951m9.345-8.334V6.637c0-1.621-1.152-3.026-2.76-3.235A48.455 48.455 0 0011.25 3c-2.115 0-4.198.137-6.24.402-1.608.209-2.76 1.614-2.76 3.235v6.226c0 1.621 1.152 3.026 2.76 3.235.577.075 1.157.14 1.74.194V21l4.155-4.155" /></svg> },
                ].map((d) => (
            ...
            <div className="relative hidden lg:block">
              ...
              <div className="relative rounded-2xl border-2 border-border bg-white p-8 shadow-xl">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div><h4 className="text-lg font-bold text-dark">SEO Audit Report</h4><p className="text-xs text-muted">ihr-unternehmen.de — Maerz 2026</p></div>
                </div>
