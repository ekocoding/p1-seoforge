...
export const services = [
  ...
  {
    title: "Linkbuilding Agentur",
    href: "/linkbuilding-agentur",
    description:
      "Redaktioneller Linkaufbau, Digital PR und manuell geprüfte Quellen statt austauschbarer Linkpakete.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6">
        <path d="M10.5 13.5l3-3" /><path d="M7.05 16.95l-1.5 1.5a3.182 3.182 0 104.5 4.5l3-3a3.182 3.182 0 000-4.5" /><path d="M16.95 7.05l1.5-1.5a3.182 3.182 0 10-4.5-4.5l-3 3a3.182 3.182 0 000 4.5" />
      </svg>
    ),
  },
];
